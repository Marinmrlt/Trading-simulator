...
import { InvalidOrderError, TradeExecutionError } from './errors/trade.errors';
...
import type { IExchangeAdapter } from './interfaces/exchange-adapter.interface';
import { OrderNotFoundError, OrderNotCancellableError } from './errors/trade.errors';
